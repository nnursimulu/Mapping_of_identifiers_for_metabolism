...
#python3 scripts/3_parse_out_rxn_definitions.py --output-folder $OUTSIDE_INFO --parsed-info $PARSED_INFO --parsed-split-rxn-info $PARSED_RXN_SPLIT_INFO
python3 scripts/4_determine_rxn_reversibility_equiv.py --parsed-info $PARSED_INFO --parsed-split-rxn-info $PARSED_RXN_SPLIT_INFO